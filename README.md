# Accident Analytics Platform

Accident Analytics Platform integrates official German road-accident open data into a normalized PostgreSQL database. It exposes reproducible answers through a documented FastAPI service and a React dashboard, with source and license provenance attached to every data response.
